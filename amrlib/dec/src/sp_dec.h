...
typedef struct
{
    Decoder_amrState  decoder_amrState; /* as output parameter of Decoder_arm() */
    Post_FilterState  post_state; /* as output parameter of Post_Filter() */
    Post_ProcessState postHP_state; /* as output parameter of Post_Process() */
    enum Mode prev_mode;
