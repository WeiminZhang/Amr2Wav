...
#include "oscl_mem.h"
#include "oscl_array.h"

#define KCAI_CODEC_INIT_FAILURE -1
#define BUF_SIZE	1024
#define OsclErrNoMemory "Memory is NULL"
        ...
        bool aAllocateOutputBuffer)
{
    ...
    {
        iInputBuf = (int16 *)OSCL_ARRAY_NEW((int16)BUF_SIZE, MAX_NUM_PACKED_INPUT_BYTES);
        if (iInputBuf == NULL)
        {
    ...
    {
        iOutputBuf = (int16 *)OSCL_ARRAY_NEW((int16)BUF_SIZE, L_FRAME);
